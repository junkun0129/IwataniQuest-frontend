...
export class TileManager {
  ...
  public draw(c: CanvasRenderingContext2D): void {
    ...
    c.drawImage(
      ...
      this.minimapX,
      this.minimapY,
      this.gp.worldWidth / this.minimapShrink,
      this.gp.worldHeight / this.minimapShrink
    );
    ...
    c.arc(
      this.minimapX +
        this.gp.tilesize / this.minimapShrink +
        this.gp.player.playerX / this.minimapShrink,
      this.minimapY +
        this.gp.tilesize / this.minimapShrink +
        this.gp.player.playerY / this.minimapShrink,
      6,
      0,
      100
    );
